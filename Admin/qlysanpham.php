            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Bảo trì sản phẩm</h3>
                </div><!-- /.box-header -->
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                         ...
                         $sql="SELECT s.ID,s.Ten,s.date,s.Gia,s.HinhAnh,s.tacgia,s.KhuyenMai,s.Mota, n.Ten as Tennhasx,Tendanhmuc,s.soluongkho,s.date
                         from sanpham s 
                      ...
                      ?>       
                        ...
                        <td><?php echo currency_format($row["Gia"]) ?></td>
