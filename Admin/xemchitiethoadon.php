            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Chi tiết hóa đơn <?= $_GET['sodh']; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <div class="box-footer">
                      <a href="quanlyhoadon.php?hd_dangcho"><button type="button" name="cancel" class="btn btn-default">Thoát</button></a>
                    </div>
                </div><!-- /.box-body -->
