			...
			<div class="col-lg-12">
				...
				<?php
					...
					$query="SELECT * from sanpham ORDER BY date DESC LIMIT $start, $limit;";
					$rs = $conn->query($query);
					if ($rs->num_rows > 0) {
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="product">
							<div class="image"><a href="product.php?id=<?php echo $row["ID"]?>"><img src="images/<?php echo $row["HinhAnh"]?>" style="width:250px;width:100%;height:300px"/></a></div>
							<div class="caption">
								...
								<div class="price"><?php echo currency_format($row["Gia"]) ?></div>
