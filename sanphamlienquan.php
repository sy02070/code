...
<div class="product-related">
	...
	<?php
		...
		from sanpham WHERE  manhasx = '$mansx' AND ID != '$id' limit 3 " ;
	...
	?>
		...
		<div class="col-lg-4 col-md-4 col-xs-12">
			<div class="product">
				<div class="image"><a href="product.php?id=<?php echo $dong["ID"]?>"><img src="images/<?php echo $dong["HinhAnh"]?>" style="width:250px;width:100%;height:300px"/></a></div>
				<div class="caption">
